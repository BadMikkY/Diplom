package com.example.diplom.screen.workerNavigationBar
...
import com.example.diplom.screen.workerBookings.WorkerBookingsScreen
import com.example.diplom.screen.workerMain.WorkerMainScreen
import com.example.diplom.screen.workerSettings.WorkerSettingsScreen

@SuppressLint("UnusedMaterial3ScaffoldPaddingParameter")
@Composable
fun BottomWorkerBarScreen() {

    val screens = listOf(
        Destination.WorkerMainScreen,
        Destination.WorkerBookingsScreen,
        Destination.WorkerSettingsScreen
    )
    ...
    Scaffold(
        ...
        NavHost(
            ...
            startDestination = Destination.WorkerMainScreen
        ) {


            composable(destination = Destination.WorkerMainScreen) {
                WorkerMainScreen()
            }
            composable(destination = Destination.WorkerBookingsScreen) {
                WorkerBookingsScreen()
            }

            composable(destination = Destination.WorkerSettingsScreen) {
